## AEM Blog Post (Culture Tecture / re-think)

Use these instructions when asked to write a Culture Tecture or re-think.adobe.com
blog post, document something built as a post, or create an AEM blog entry.
Keywords: "culture tecture", "AEM blog", "re-think blog", "write a blog post",
"blog about what we built", "document what I built as a post".
