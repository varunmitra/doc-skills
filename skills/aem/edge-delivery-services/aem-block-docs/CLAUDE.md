## AEM Block Library Documentation

Use these instructions when asked to document an AEM EDS block, write block library
docs, add a block to the Sidekick Library, or describe how to author a block.
Keywords: "document this block", "write block docs", "block library docs",
"add to block library", "how do I author this block".

Output format: AEM Sidekick Block Library plugin `.md` format — working EDS table
examples per variation, not narrative documentation.
